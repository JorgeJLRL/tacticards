...
export default function User(){
    ...
    return(
        ...
        <div className={styles.imagebg}>
                ...
                <img
                src={"/images/GamalielRodriguez.jpg"}
        ...
        <div className={styles.contentBox} >
                ...
                <ul className={styles.unorderedList}>
                    <li className={styles.listContact}><img src="/images/telephoneRad.png"/><a className={styles.anchorText} href="tel:+6672437043;?
                    &amp;name=Gamaliel%Rodriguez">(667) 243 7043</a></li>
                    <li className={styles.listContact}><img src="/images/MessageRad.png"/><a className={styles.anchorText}>ventas5@diesel.plus</a></li>
