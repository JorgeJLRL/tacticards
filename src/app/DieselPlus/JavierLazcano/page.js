...
import Mensaje from "../../DieselPlus/JavierLazcano/contactJL.client"
import React from "react"
import Red from "../../components/dieselplusredes/JavierLazcano/redJL.js"
...
export default function User(){
    ...
    const fotoperfil= "/images/JavierLazcano.png"
    const name= "Javier Lazcano";
    const puesto = "Agente de Ventas";
    const empresa = "DiéselPlus";
    const whatsapp = "6683248186"
    const correo = "ventas4@diesel.plus"
    ...
    const namecontact = "Javier%Lazcano"
    ...
    return(
        ...
        <div className={styles.contentBox} >
                ...
                <ul className={styles.unorderedList}>
                    ...
                    &amp;name=${namecontact}`}>(668) 324 8186</a></li>
