    ...
    return(
        ...
        <div className={styles.contentBox} >
                ...
                <ul className={styles.unorderedList}>
                    <li className={styles.listContact}><img src="/images/telephoneRad.png"/><a className={styles.anchorText} href="tel:+6688562647">(668) 856 2647</a></li>
                    ...
                    <li className={styles.listContact}><img src="/images/cellphoneRad.png"/><a className={styles.anchorText} href="tel:+668188629">(668) 818 8629</a></li>
                </ul>
